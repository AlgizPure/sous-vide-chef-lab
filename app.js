...
const CATEGORY_SUBMENUS = {
  ...
  beef: [
    ...
    { key: 'sport', label: '💪 Лопатка и томление', match: r => ['demian-beef-shoulder-pulled', 'demian-beef-sear-flour', 'beef-chuck-prime-rib', 'beef-herb-crusted-chuck-roast', 'beef-chuck-pot-roast', 'beef-chuck-pastrami', 'beef-denver-steak'].includes(r.id) },
...
======================================================================
  НЕ МЕЛЬЧИТЕ! КУБИКИ ДОЛЖНЫ БЫТЬ КРУПНЫМИ (4–5 СМ):
    ...
    steps: [
      ...
      {
        num: 3,
        title: 'Предварительное колерование (Sear first)',
        action: 'Перед закладкой в пакет сильно обжарьте кубики на раскаленной сковороде партиями по 1.5–2 минуты для запуска реакции Майяра. Затем деглазируйте сковороду вином.',
        warning: 'Не выкладывайте все мясо сразу на сковороду — сковорода остынет и мясо пустит сок вместо жарки.'
      }
    ],
    target: 'Кубики тающего мясного рагу, пропитанные винно-мясным соусом.'
  }
};
...
function showAppVersionInfo() {
  ...
  const swState = (navigator.serviceWorker && navigator.serviceWorker.controller) ? 'Активен (v3.8)' : 'Автономен';
