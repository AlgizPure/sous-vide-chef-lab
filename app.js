...
function renderDrawerRecipes(searchTerm = '') {
  ...
  categories.push(
    ...
    { key: 'meat', title: '🍖 Баранина, Кролик и Плов', filter: r => r.category === 'meat' },
    ...
    { key: 'other', title: '🍽 Другие блюда', filter: r => !r.isChef && !['poultry','beef','pork','fish','eggs','meat','sauces'].includes(r.category) }
  );
